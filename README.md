...
1. Pircēja shemas, koncepta vai papīra uzzimēta attēlu apstrade un formatēšāna pēc EU standartiem .
   ...
   <br><br>
3. Šo attēlu verifikācija, kurā savi ietilps, parbaudīt, kā attēlā ir tekst un shēma.
<br>
   (P.S. Verifikācija ir lasāms teksts un shēmas elementi (līnijas, formas, bultiņas),
